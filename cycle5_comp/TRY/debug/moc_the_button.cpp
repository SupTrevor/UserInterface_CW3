...
QT_MOC_LITERAL(4, 33, 7), // "jumpTo2"
QT_MOC_LITERAL(5, 41, 7), // "clicked"
QT_MOC_LITERAL(6, 49, 10), // "addinQueue"
QT_MOC_LITERAL(7, 60, 4) // "info"

    },
    "TheButton\0jumpTo\0\0TheButtonInfo*\0"
    "jumpTo2\0clicked\0addinQueue\0info"
};
...
void TheButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->jumpTo2((*reinterpret_cast< TheButtonInfo*(*)>(_a[1]))); break;
        case 2: _t->clicked(); break;
        case 3: _t->addinQueue((*reinterpret_cast< TheButtonInfo*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (TheButton::*_t)(TheButtonInfo * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TheButton::jumpTo2)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void TheButton::jumpTo2(TheButtonInfo * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
